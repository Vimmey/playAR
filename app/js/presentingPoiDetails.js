...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		World.markerDrawable_idle = new AR.ImageResource("assets/map-marker-icon.png");
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
			...
			console.log("restaurant distance ****** " + poiData[currentPlaceNr].distance);
	...
	updateDistanceToUserValues: function updateDistanceToUserValuesFn() {
		for (var i = 0; i < World.markerList.length; i++) {
			World.markerList[i].distanceToUser = World.markerList[i].poiData.distance;
			World.markerList[i].title = World.markerList[i].poiData.title;
			World.markerList[i].rating = World.markerList[i].poiData.rating;
			console.log(World.markerList[i].rating);
		}
	},
	...
	*/
	...
	// udpates values show in "range panel"
    	updateRangeValues: function updateRangeValuesFn() {
    		...
    		console.log("************: "+World.getMaxDistance());
    		console.log("************: "+maxRangeMeters);

    		// range in meters including metric m/km
    		var maxRangeValue =((maxRangeMeters / 1000).toFixed(2) + " km");;
